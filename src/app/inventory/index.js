      ...
      table1ColumnHelper.accessor("rowdateorder", {
        cell: (info) => (
          <div className="ml-[22px] flex justify-center">
            <Text
              as="p"
              className="w-full text-center text-[25px] font-normal leading-9 text-[#000000] lg:text-[17px]"
            >
              {info.getValue()}
            </Text>
          </div>
      ...
      table1ColumnHelper.accessor("rowstatus", {
        cell: (info) => (
          <div className="ml-[52px] flex flex-1 items-center justify-center sm:flex-col">
            <Text
              as="p"
              className="text-center text-[25px] font-normal leading-9 text-[#000000] lg:text-[17px] sm:px-5"
            >
              {info.getValue()}
            </Text>
            <Img
