...
const table1Data = Array.from({ length: 10 }, (_, index) => ({
  rowid: `0${index + 1}`,
...
export default function OrderManagementPage() {
      ...
      table1ColumnHelper.accessor("rowid", {
        ...
        header: () => (
          <div className="flex px-1">
            <Heading
              as="h2"
              className="w-full text-center text-[20px] font-bold leading-[45px] text-[#ffffff] lg:text-[21px]"
            >
              ID
            </Heading>
          </div>
      ...
      table1ColumnHelper.accessor("rowcustomer", {
        cell: (info) => (
          <div className="ml-[38px] flex justify-center">
            <Text
              as="p"
              className="w-[88%] text-center text-[20px] font-normal leading-9 text-[#000000] lg:text-[17px]"
            >
              {info.getValue()}
            </Text>
          </div>
        ...
        header: () => (
          <div className="ml-[38px] flex">
            <Heading
              as="h3"
              className="flex-1 text-center text-[20px] font-bold leading-[45px] text-[#ffffff] lg:text-[21px]"
            >
              Customer
            </Heading>
          </div>
      ...
      table1ColumnHelper.accessor("rowstatus", {
        cell: (info) => (
          <div className="ml-[52px] flex flex-1 items-center justify-center sm:flex-col">
            <Text
              as="p"
              className="text-center text-[20px] font-normal leading-9 text-[#000000] lg:text-[17px] sm:px-5"
            >
              {info.getValue()}
            </Text>
            <Img
        ...
        header: () => (
          <div className="ml-[52px] flex flex-1">
            <Heading
              as="h6"
              className="w-[48%] text-center text-[20px] font-bold leading-[45px] text-[#ffffff] lg:text-[21px]"
            >
              Status
            </Heading>
          </div>
  ...
  return (
    <div className="">
      <div className="py-[30px] px-5 flex flex-1 flex-col gap-[30px]">
        <div className="mr-5 flex items-center justify-center md:mr-0 md:flex-col">
          ...
          <div className="flex flex-1 justify-end md:flex-col md:self-stretch md:px-5">
            ...
            <SelectBox
              ...
              className="ml-5 min-w-[100px] gap-2.5 rounded-[5px] border border-solid border-[#f25d87] font-['Nunito_Sans'] md:ml-0 md:w-full"
            />
            <Button
              color="orange_800"
              size="xs"
