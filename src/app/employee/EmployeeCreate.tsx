        ...
        <form>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex  items-center">
              <label
                htmlFor="name"
                className="min-w-[100px] xt-gray-700 capitalize mb-2"
              >
                Name
              </label>
              <Input
            ...
            <div className="flex  items-center">
              <label
                htmlFor="dob"
                className="min-w-[100px] t-gray-700 capitalize mb-2"
              >
                Date of Birth
              </label>
              <Input
            ...
            <div className="flex col-span-2">
              <div className="w-[50%] mr-[20px]">
                <div className="flex  items-center mb-2">
                  <label
                    htmlFor="address"
                    className="xt-gray-700 capitalize mb-2 min-w-[100px]"
                  >
                    Address
                  </label>
                  <Input
              ...
              <div className="flex flex-col items-center items-center col-span-2">
                <label className="block xt-gray-700 mb-2">Picture</label>
